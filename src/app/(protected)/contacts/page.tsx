...
export default async function ContactsPage(props: { searchParams?: Promise<{ q?: string; relationship?: string; sort?: string; create?: string }> }) {
  ...
  return <PageShell entity="contacts" wide eyebrow="Relații comerciale" title="Contacte" description="Oamenii relațiilor comerciale: compania, rolul și legătura cu oportunitățile active.">
