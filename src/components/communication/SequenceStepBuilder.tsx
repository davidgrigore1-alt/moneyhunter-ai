...
function StepEditor({ step, index, count, onChange, onMove, onRemove }: {
  ...
  const label = step.type === "email" ? "Email pregătit" : step.type === "wait" ? "Așteptare" : "Acțiune manuală";
